...
function consent() {
    ...
    showConsent: new function(req, res, next) {
        ...
        this.prepareCustomContentData(req,res,consentData,function(err,customData){
            if (err) {
    ...
    prepareCustomContentData : new function(req, res, consentData, cb) {cb(null,consentData);}; //Override for custom data. return cb(error,customData).
    doConsent: new function (req, res, next) {
    ...
    customDoConsent:new function(req,res,consentData,cb) {cb(null,consentData,true);};//Override for custom implementation on users' agree consent.  Return cb(err,consentData,isDefaultResponse)
    customRejectConsent:new function(req,res,consentData,cb) {cb(null,consentData,true);};//Override for custom implementation on users' agree consent.  Return cb(err,consentData,isDefaultResponse)
    getAccessToken: new function (req, res, next, formData) {
